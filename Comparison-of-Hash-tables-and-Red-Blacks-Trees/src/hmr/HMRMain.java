...
public class HMRMain {
    ...
    public static LinkedList<LinkedList<Long>> testResizeble(int testNumber) throws IOException {
        /* I/O and statistic initialization */
        Scanner scan = new Scanner(new File("in/test"+ testNumber+ ".in"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("out/test"+ testNumber + ".out3"));
        ...
        HashMapResizable hashMap = new HashMapResizable();
