...
public class HMCMain {
    ...
    public static LinkedList<LinkedList<Long>> testCollision(int testNumber) throws IOException {
        /* I/O and statistic initialization */
        Scanner scan = new Scanner(new File("in/test"+ testNumber+ ".in"));
        BufferedWriter writer = new BufferedWriter(new FileWriter("out/test"+ testNumber + ".out1"));
        LinkedList<LinkedList<Long>> opTime = new LinkedList<>();
        for (int i = 0; i < 5; i++) {
            opTime.add(new LinkedList<>());
        }
        /* Data Structures Initialization */
        HashMapDefaultCollision hashMap = new HashMapDefaultCollision();
